...
export const [category]Posts: BlogPost[] = [
  // ... 既存記事
  {
    ...
    lastUpdated: '2025-10-10',   // 更新日（オプション）
...
| Ver | 日付       | 内容                                   |
| --- | ---------- | -------------------------------------- |
| 4.0 | 2025-10-10 | コンポーネント化・リファクタリング完了 |
| 3.1 | 2025-10-10 | Business Tools追加、テンプレート拡充   |
| 3.0 | 2025-10-10 | バッジシステム追加、UI簡略化           |
| 2.0 | 2025-10-10 | カテゴリ分離構造                       |
| 1.0 | 2025-10-21 | 初版                                   |
