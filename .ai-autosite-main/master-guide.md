...
| # | カテゴリー | 説明 |
|---|-----------|------|
| 1 | Converters | ファイル・データ変換 |
| 2 | Editors | テキスト・コンテンツ編集 |
| 3 | Image Tools | 画像処理・加工 |
| 4 | Generators | コンテンツ・コード生成 |
| 5 | Analyzers | 分析・検査 |
| 6 | AI Tools | AI機能ツール |
| 7 | Dev Tools | 開発者ツール |
| 8 | Learning | 学習・教育 |
| 9 | Audio Tools | 音声処理 (NEW!) |
...
| Ver | 日付       | 内容                               |
| --- | ---------- | ---------------------------------- |
| 8.0 | 2025-12-15 | GPU処理ツール追加、カテゴリー9個に拡張 |
| 7.0 | 2025-10-17 | ドキュメント分割・リファクタリング |
| 6.1 | 2025-10-17 | AIバッジシステム追加               |
| 6.0 | 2025-10-17 | 完全版リファクタリング             |
| 5.0 | 2025-10-17 | OpenGraph追加                      |
| 4.0 | 2025-10-10 | ツールプロパティ定義追加           |
| 3.0 | 2025-10-10 | 初版統合ガイド作成                 |
