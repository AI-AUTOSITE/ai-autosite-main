  ...
  return (
        ...
        <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm text-cyan-300">
              ...
              <p className="mt-2">Supports GitHub Flavored Markdown (GFM) with tables and code blocks.</p>
            </div>
          </div>
        </div>
          ...
          <ol className="space-y-3">
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Use the left panel for your markdown input</p>
              </div>
            </li>
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Toggle between Preview (visual) or HTML (code)</p>
              </div>
            </li>
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Check the formatted result or raw HTML code</p>
              </div>
            </li>
    ...
    <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
      <p className="text-sm text-amber-300">
        <strong>Pro Tip:</strong> Click "Load Sample" to see all supported Markdown features including tables, 
        code blocks, and formatting options.
      </p>
    </div>
  </div>
</div>
