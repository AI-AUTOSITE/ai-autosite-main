...
export const metadata: Metadata = {
  ...
  description: 'Calculate your exact age instantly. 100% free, no ads, no tracking, no email required. Works offline in your browser.',
  keywords: 'free age calculator, no ads, no sign up, birthday calculator, days old, privacy, no tracking',
  openGraph: {
