import { Hash, Calculator, Calendar, Heart, Percent, 
  Twitter, Clock, Grid3x3, Palette, Ruler, HardDrive, Shield, 
  FileText, Image, Type, Sparkles, Scissors, QrCode, FileSpreadsheet } from 'lucide-react'
...
export const quickToolsPosts: BlogPost[] = [
  ...
  },
  {
    ...
    description: 'Generate QR codes for URLs, WiFi, text, and more. Customize colors and styles for your brand.',
    readTime: '4 min',
    publishDate: 'January 2025',
    icon: QrCode,
    featured: false,
    ...
    seoDescription: 'Generate QR codes for URLs, WiFi, text, and more. Customize colors and download in high quality. Free online tool.',
...

  {
    ...
    description: 'Instantly blur sensitive information in images. Perfect for sharing screenshots safely on social media.',
    readTime: '3 min',
    publishDate: 'January 2025',
    icon: Shield,
    featured: true,
  ...
  },
  {
    ...
    description: 'Convert PDF tables to CSV or Excel format using AI. Extract data from scanned documents with high accuracy.',
    readTime: '5 min',
    publishDate: 'January 2025',
