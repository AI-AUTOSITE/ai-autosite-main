...
export const creativeToolsPosts: BlogPost[] = [
  {
    ...
    seoDescription: 'Generate engaging Instagram bios that attract followers. Free templates and ideas for your profile. Stand out on Instagram.',
  ...
  },
  {
    ...
    seoDescription: 'Download YouTube video thumbnails in HD quality. Free tool for content creators and designers. Get any video thumbnail instantly.',
  ...
  },
  {
    ...
    seoDescription: 'Generate beautiful CSS gradients for web design. Live preview, custom colors, and easy copy-paste code. Free gradient tool.',
