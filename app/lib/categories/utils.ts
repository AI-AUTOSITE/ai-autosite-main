...
export const getLiveTools = (tools: Tool[]) => 
...
export const getToolById = (tools: Tool[], id: string) => 
  tools.find(tool => tool.id === id)

export const getToolByUrl = (tools: Tool[], url: string) => 
...
export const validateTool = (tool: Partial<Tool>): string[] => {
  ...
  if (tool.difficulty && !['Instant', 'Simple', 'Intermediate', 'Advanced'].includes(tool.difficulty)) {
