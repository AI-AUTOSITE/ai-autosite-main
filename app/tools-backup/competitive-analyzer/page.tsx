...
const CompetitiveAnalyzerClient = dynamic(
  () => import('./components/CompetitiveAnalyzerClient'),
  { 
    ssr: false,
    loading: () => (
...
export const metadata: Metadata = {
  ...
  description: 'Analyze competitors and find market gaps instantly. 100% free, no ads, no tracking, no email required. Your business ideas never leave your browser.',
  keywords: 'free competitive analysis, no ads analyzer, market research tool, competitor analysis, no sign up, no tracking, privacy tool, open source analyzer, github',
  openGraph: {
  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <p>
          Analyze competitors, identify market gaps, and generate product ideas instantly 
          with our AI-powered competitive analysis tool. No sign-up required, no ads, 
          and your business ideas are never stored.
        </p>
        <h2>Key Features</h2>
        <ul>
        ...
        <h2>Privacy First</h2>
        <p>
          Your business ideas are processed in real-time and never stored. 
          We don't track users, show ads, or require any personal information. 
