    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Doodle Icons Collection</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-white rounded-xl p-6 border border-gray-200">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold text-gray-900">Selected: {currentPalette.name}</h3>
      ...
      <div className="bg-gradient-to-br from-white to-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-gray-800 mb-8">Your Brand Colors in Action</h2>

          {/* Dashboard Example */}
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            <h3
              className="text-lg font-semibold mb-4"
              style={{ color: currentPalette.colors.secondary }}
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div
                ...
                style={{ borderColor: currentPalette.colors.primary }}
              >
              ...
              <div
                ...
                style={{ background: `${currentPalette.colors.primary}15` }}
              >
                <div className="flex items-center gap-3 mb-2">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div
              ...
              style={{ borderColor: currentPalette.colors.primary + '40' }}
            >
                ...
                <div className="flex items-center gap-6">
                  ...
                  <nav className="flex gap-4">
                    <a
                      ...
                      style={{
                        color: currentPalette.colors.primary,
                        backgroundColor: currentPalette.colors.primary + '15',
                      }}
                    >
          ...
          <div className="bg-gray-900 text-gray-100 rounded-xl p-6">
            <h3 className="text-lg font-semibold mb-4 text-white">Export Your Brand Colors</h3>
