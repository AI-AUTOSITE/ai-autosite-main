...
export const metadata: Metadata = {
  ...
  description:
    'Practice debates with AI opponents. 100% free, no ads, no tracking. Get scored feedback instantly.',
  keywords:
    'free debate trainer, no ads, ai debate, argumentation, privacy, no sign up, critical thinking',
  openGraph: {
