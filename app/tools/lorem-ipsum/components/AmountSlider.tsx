  ...
  return (
    <div>
      ...
      >
        ...
        <Slider.Thumb
          className="block w-5 h-5 bg-white rounded-full shadow-lg hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900 cursor-grab active:cursor-grabbing transition-all"
          aria-label={label}
        />
      </Slider.Root>
