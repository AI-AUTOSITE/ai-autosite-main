...
export default function ErrorMessage({ message, onReset }: ErrorMessageProps) {
  ...
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20 w-[calc(100%-2rem)] sm:max-w-md">
        ...
        <div className="p-3 sm:p-4">
          ...
          {onReset && (
            <div className="mt-3 pt-3 border-t border-red-400/30">
              <button
                onClick={onReset}
                className="w-full px-4 py-2.5 min-h-[44px] bg-white/10 hover:bg-white/20 
