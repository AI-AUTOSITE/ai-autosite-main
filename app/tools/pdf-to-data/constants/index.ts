...
export const ERROR_MESSAGES = {
  ...
  IMAGE_BASED_PDF: 'This PDF contains only images. Please use a text-based PDF or try OCR software first.',
  CORRUPTED_PDF: 'The PDF file appears to be corrupted. Please try re-downloading or using a different file.',
