...
export default function BusinessToolsClient() {
  const tools = useMemo(
    () => getToolsByCategory('business-tools').filter((t) => t.status === 'active'),
    []
  )
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-400">
            {tools.length} professional tools for business productivity.
          </p>
        </div>
