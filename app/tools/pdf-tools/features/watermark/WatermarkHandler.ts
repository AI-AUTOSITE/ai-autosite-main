...
export class WatermarkHandler {
  static async addWatermark(file: File, options: WatermarkOptions): Promise<Uint8Array> {
  ...
  private static async addTextWatermark(pages: PDFPage[], options: WatermarkOptions) {
