...
export const metadata: Metadata = {
  ...
  description:
    'Browse our collection of 50+ free online tools. No ads, no tracking, instant access. Tools for developers, students, professionals, and creators.',
  keywords:
    'free tools, online tools, developer tools, creative tools, business tools, study tools, no ads, privacy-first',
  openGraph: {
