...
export default function SpamEmailCheckerGuide({ onClose }: { onClose?: () => void }) {
  return (
    <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 max-w-md">
      ...
      <div className="space-y-3">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <p className="text-white font-medium">Copy sender address</p>
            <p className="text-gray-400 text-sm">From the suspicious email</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            <p className="text-white font-medium">Paste & check</p>
            <p className="text-gray-400 text-sm">Get instant safety analysis</p>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Follow recommendations</p>
          </div>
        </div>
      </div>
