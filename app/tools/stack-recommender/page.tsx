...
export const metadata: Metadata = {
  ...
  description:
    'Get personalized tech stack recommendations in 30 seconds. 100% free, no ads, no tracking.',
  keywords:
    'free stack recommender, tech stack generator, no ads, ai development, privacy, no sign up',
  openGraph: {
