...
export const metadata: Metadata = {
  ...
  description:
    'Analyze project structure, compress code for AI, and visualize dependencies. Upload files to get started. 100% free, no ads, no tracking.',
  keywords:
    'code analyzer, dependency visualizer, code compressor, free tool, no ads, AI optimization',
  openGraph: {
