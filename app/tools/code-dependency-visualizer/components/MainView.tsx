    ...
    <div className="space-y-6 relative">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-white/5 backdrop-blur-xl rounded-lg p-4 border border-white/10">
          ...
          <div className="text-2xl font-bold text-white">{analysis.stats.totalFiles}</div>
        </div>
            ...
            {compressed.length > 0 ? (
              <>
                <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-lg p-4 border border-cyan-400/30">
                  <p className="text-cyan-400 font-medium mb-2">Compression Complete!</p>
                ...
                <div className="space-y-2 max-h-64 overflow-y-auto custom-scrollbar">
                  {compressed.map((file, index) => (
                    ...
                    >
                      ...
                      <span className="text-cyan-400 text-sm ml-4">-{file.compressionRate}%</span>
                    </div>
                  ))}
                </div>
              </>
