...
export const metadata: Metadata = {
  ...
  description: 'Generate custom test files instantly for upload testing. Set exact file size, content type, and complexity. 100% free, no ads, no tracking. Works offline.',
  keywords: 'test file generator, dummy file creator, sample pdf, upload testing, file size generator, development tools, free, no ads',
  
  openGraph: {
    title: 'Test File Generator - Truly Free, No Ads Ever',
    description: 'Zero ads, zero tracking, zero BS. Create custom test files with exact size and content specifications.',
    type: 'website',
    images: [{
