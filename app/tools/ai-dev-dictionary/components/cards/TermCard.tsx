...
export default function TermCard({ term, onSelect, compact = false }: TermCardProps) {
  ...
  return (
    ...
    >
      <div className={`relative bg-slate-800/50 backdrop-blur rounded-xl 
        ...
        <div className="relative p-4">
          ...
          <div className="w-full py-2 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 
