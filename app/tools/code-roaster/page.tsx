...
export const metadata: Metadata = {
  ...
  description:
    'Get hilarious AI code reviews instantly. 100% free, no ads, no tracking. Debug and improve code with humor.',
  ...
  openGraph: {
    ...
    description:
      'Zero ads, zero tracking, zero BS. Get hilarious AI code reviews that actually help.',
    type: 'website',
    images: [
      {
