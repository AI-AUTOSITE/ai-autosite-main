...
export const metadata: Metadata = {
  ...
  description: 'Professional developer tools for debugging, testing, and optimizing code. JSON formatter, regex tester, API testing tools. No ads.',
  keywords: 'developer tools, debugging tools, json formatter, regex tester, api tools, free, no ads',
  openGraph: {
