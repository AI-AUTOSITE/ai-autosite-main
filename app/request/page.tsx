        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Have an idea for a tool that would make your workflow better? We build based on real
          ...
          <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 backdrop-blur-xl rounded-2xl border border-white/10 p-8 mb-12 text-center">
            ...
            <p className="text-gray-400 mb-6">
              The best tools come from real problems that need solving. Share your idea and help us
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-xl rounded-2xl border border-white/10 p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-400 text-sm">
                    1-2 weeks for basic utilities and converters
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-400 text-sm">
                    1-2 months for advanced analysis or AI features
                  </p>
                </div>
                <div className="text-center">
              ...
              <p className="text-center text-gray-500 text-sm mt-6">
                Timelines vary based on complexity and team capacity. We always prioritize quality
                over speed.
              </p>
            </div>
          </section>
          ...
          <section>
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 text-center">
              ...
              <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
                Every tool we build started as a user request. Your idea could be the next one that
                helps thousands of people work more efficiently.
              </p>
