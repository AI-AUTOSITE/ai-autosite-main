...
export const metadata: Metadata = {
  ...
  description: 'Learn how to instantly summarize PDF documents with AI. Extract key points, save time on research, and boost productivity.',
            ...
            <ol className="space-y-4">
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Simply drag and drop or click to upload any PDF file up to 10MB. 
                    Supports all types of documents from research papers to business reports.
                  </p>
                </div>
              </li>
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Select from short (bullet points), medium (executive summary), 
                    or long (comprehensive analysis) based on your needs.
                  </p>
                </div>
              </li>
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Receive a well-structured summary in Markdown format. 
                    Copy to clipboard or download for your records.
                  </p>
                </div>
              </li>
            </ol>
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-green-500/10 to-teal-500/10 rounded-xl p-6 border border-green-500/20">
              <h3 className="text-xl font-semibold text-green-400 mb-2">Short Summary (100-200 words)</h3>
            ...
            <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-xl p-6 border border-cyan-500/20">
              <h3 className="text-xl font-semibold text-cyan-400 mb-2">Medium Summary (300-500 words)</h3>
              <p className="text-gray-300 mb-3">
            ...
            <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl p-6 border border-purple-500/20">
              <h3 className="text-xl font-semibold text-purple-400 mb-2">Long Summary (800+ words)</h3>
              <p className="text-gray-300 mb-3">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-gray-300 mb-4">
                  Our PDF Summarizer uses Claude AI, one of the most advanced language models available, 
                  to understand and summarize your documents with human-level comprehension.
                </p>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <p className="text-gray-300">
                  <strong className="text-white">Use text-based PDFs:</strong> Scanned images or handwritten 
                  documents may not process correctly. Use OCR first if needed.
                </p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
                <p className="text-gray-300">
                  <strong className="text-white">Start with medium length:</strong> It provides the best 
                  balance of detail and brevity for most documents.
                </p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-1">✓</span>
                <p className="text-gray-300">
                  <strong className="text-white">Download important summaries:</strong> Save summaries 
                  locally for future reference and study.
                </p>
              </li>
            </ul>
          </div>
