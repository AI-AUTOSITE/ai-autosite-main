...
export const metadata: Metadata = {
  ...
  description:
    'Split large images into printable paper sizes automatically. Learn how to create posters, banners, and large prints using your standard printer.',
  keywords:
    'image splitter, paper size, A4 printing, poster printing, banner printing, image tile, split image for printing',
  openGraph: {
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-300 leading-relaxed">
          Transform large images into perfectly sized tiles for any paper format. Create stunning
          posters, banners, and wall art using just your standard home or office printer.
        </p>
      </header>
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-gray-300 leading-relaxed mb-4">
              ...
              banner for an event without expensive printing services? Our Image Splitter solves
              this universal problem instantly.
            </p>
            <p className="text-gray-300 leading-relaxed">
              By intelligently splitting your image into standard paper sizes, you can print large
              formats piece by piece, then assemble them into impressive displays—all with the
              printer you already have.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-xl p-6 border border-blue-500/20">
              ...
              <p className="text-gray-300">
                Choose between paper-based splitting (A4, Letter, Legal) or custom grid splits (2×2,
                3×3, etc.) for maximum flexibility.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-xl p-6 border border-green-500/20">
              ...
              <p className="text-gray-300">
                Automatically calculates the best fit for your chosen paper size, with options for
                overlap to ensure seamless assembly.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-xl p-6 border border-purple-500/20">
              ...
              <p className="text-gray-300">
                Download all split images as a ZIP file, with each piece numbered for easy assembly.
            ...
            <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 rounded-xl p-6 border border-orange-500/20">
              ...
              <p className="text-gray-300">
                Visual guides and grid lines help you see exactly where your image will be split
                before processing.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Drag and drop or click to select your image (JPG, PNG, WebP supported)
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Select paper size (A4, Letter, etc.) or grid pattern (3×3, 4×4)
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  See exactly how your image will be divided with visual guides
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Get all pieces as a ZIP file with numbered filenames for easy assembly
                </p>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white/5 rounded-xl p-6">
              ...
              <p className="text-gray-300">
                Transform favorite photos into wall-sized art. Create custom murals or photo walls
                without expensive large-format printing.
              </p>
            </div>
            ...
            <div className="bg-white/5 rounded-xl p-6">
              ...
              <p className="text-gray-300">
                Print large charts, graphs, or architectural plans. Ideal for meetings where digital
                displays aren't available.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl p-8 border border-purple-500/20">
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-2">
              ...
              <p className="text-gray-300">
                <strong className="text-white">Use high-resolution images:</strong> Start with the
                highest quality image possible for sharp prints
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-purple-400 mt-1">•</span>
              <p className="text-gray-300">
                <strong className="text-white">Add overlap margins:</strong> Enable 5-10mm overlap
                for easier alignment when assembling
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-purple-400 mt-1">•</span>
              <p className="text-gray-300">
                <strong className="text-white">Print borderless:</strong> Use your printer's
                borderless setting to avoid white edges
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-purple-400 mt-1">•</span>
              <p className="text-gray-300">
                <strong className="text-white">Number reference:</strong> Keep the numbered guide
                handy during assembly
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-purple-400 mt-1">•</span>
              <p className="text-gray-300">
                <strong className="text-white">Test first:</strong> Do a test print of one tile to
                check colors and sizing before printing all
              </p>
            </li>
          </ul>
        </div>
      ...
      <section className="text-center py-12 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl border border-white/10 mt-12">
        <h2 className="text-3xl font-bold text-white mb-4">Start Splitting Images Now</h2>
