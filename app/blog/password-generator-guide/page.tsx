...
export const metadata: Metadata = {
  ...
  description:
    'Learn how to create and manage strong passwords. Best practices for online security. Free password generator included.',
  keywords:
    'password security, strong passwords, password generator, online security, password tips',
  openGraph: {
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12">
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-4">
          <span className="px-3 py-1 bg-purple-500/20 text-purple-400 rounded-full">Security</span>
          <span>•</span>
        ...
        <p className="text-xl text-gray-300 leading-relaxed">
          Your complete guide to password security. Learn what makes passwords strong and how to
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-gray-400 text-sm">30,000+ websites are hacked every day</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <Lock className="w-8 h-8 text-yellow-400 mb-2" />
              <h3 className="text-white font-semibold mb-2">Weak Passwords</h3>
              <p className="text-gray-400 text-sm">80% of breaches involve weak passwords</p>
            </div>
          </div>
          <p className="text-gray-300">
            A strong password is your first defense against hackers. Weak passwords like "123456" or
            "password" can be cracked in seconds. Strong passwords can take centuries to break.
          </p>
        </div>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Every extra character makes it exponentially harder to crack
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-2">
              ...
              <p className="text-gray-300">
                <strong className="text-white">Dictionary words:</strong> "sunshine", "football",
                "dragon"
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-400 mt-1">✗</span>
              <p className="text-gray-300">
                <strong className="text-white">Keyboard patterns:</strong> "qwerty", "123456",
                "qazwsx"
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-400 mt-1">✗</span>
              <p className="text-gray-300">
                <strong className="text-white">Personal info:</strong> Your name, birthday, pet's
                name
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-400 mt-1">✗</span>
              <p className="text-gray-300">
                <strong className="text-white">Simple substitutions:</strong> "P@ssw0rd" is still
                weak
              </p>
            </li>
          </ul>
            ...
            <ol className="space-y-3">
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Use a base password + site-specific variation
                  </p>
                </div>
              </li>
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Keep in a secure physical location, not on your computer
                  </p>
                </div>
              </li>
            </ol>
      ...
      <section className="text-center py-12 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl border border-white/10 mt-12">
        <h2 className="text-3xl font-bold text-white mb-4">Generate Your Strong Password Now</h2>
