...
export const metadata: Metadata = {
  ...
  description:
    'Learn how to create ATS-friendly resumes and compelling cover letters with our AI-powered generator. No sign-up required, 100% privacy-focused.',
  keywords:
    'AI resume generator, cover letter generator, ATS resume, job application, career tools, professional resume, CV maker, Claude AI, resume builder',
  openGraph: {
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-300 leading-relaxed">
          Transform your career with AI-powered resume and cover letter generation. Our tool uses
          Claude Opus 4.1 to create tailored, ATS-friendly documents that help you stand out in
        ...
        <div className="flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-6">
              Professional documents tailored to your target role
            </p>
            <Link
      ...
      <section className="mb-12">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-gray-300 mb-4">
            In today's job market, you're not just competing with other candidates – you're
            competing with algorithms. Over 75% of resumes are rejected by Applicant Tracking
            Systems (ATS) before a human ever sees them.
          </p>
          <p className="text-gray-300 mb-4">
            Creating a resume that's both ATS-friendly and compelling to human recruiters requires
            understanding complex formatting rules, keyword optimization, and industry-specific
            language. It's time-consuming and often frustrating.
          </p>
          <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-6 my-6">
            <h3 className="text-xl font-semibold text-white mb-3">
              Common Resume Mistakes That Cost Jobs:
            </h3>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-white mb-6">
          AI-Powered Solution with Claude Opus 4.1
        </h2>
        <div className="prose prose-invert max-w-none">
          <p className="text-gray-300 mb-6">
            Our AI Resume Generator leverages Claude Opus 4.1, one of the most advanced AI models
            available, to create professional, tailored resumes and cover letters that get results.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white/5 rounded-xl p-6 border border-white/10 hover:border-indigo-500/30 transition-all"
                >
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-white mb-8">
          5 Simple Steps to Your Perfect Resume
        </h2>
        <div className="space-y-4">
          {processSteps.map((item, index) => (
            <div
              key={index}
              className="flex items-start gap-4 bg-white/5 rounded-xl p-6 border border-white/10"
            >
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-white/5 to-white/10 rounded-xl p-6 border border-white/10">
            ...
            <p className="text-gray-400">
              AI analyzes your target job title and experience to create perfectly matched content
          ...
          <div className="bg-gradient-to-br from-white/5 to-white/10 rounded-xl p-6 border border-white/10">
            ...
            <p className="text-gray-400">
              No account creation, no data storage. Your information is processed and immediately
              forgotten. 100% anonymous.
            </p>
          </div>
          <div className="bg-gradient-to-br from-white/5 to-white/10 rounded-xl p-6 border border-white/10">
            ...
            <p className="text-gray-400">
              Our format is optimized for both ATS systems and human readers, increasing your
        ...
        <div className="bg-gradient-to-r from-indigo-500/10 to-blue-500/10 rounded-xl p-6 border border-white/10">
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-start">
              ...
              <span>
                <strong className="text-white">Use bullet points:</strong> Start each experience
                point with an action verb and include measurable results
              </span>
            </li>
            <li className="flex items-start">
              <CheckCircle className="w-5 h-5 text-indigo-400 mr-3 mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Include numbers:</strong> "Increased sales by 40%" is
                more impactful than "Improved sales"
              </span>
            </li>
            <li className="flex items-start">
              <CheckCircle className="w-5 h-5 text-indigo-400 mr-3 mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Match keywords:</strong> Use terminology from the job
                description in your skills section
              </span>
            </li>
            <li className="flex items-start">
              <CheckCircle className="w-5 h-5 text-indigo-400 mr-3 mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Keep it concise:</strong> Aim for 1-2 pages maximum,
            ...
            <li className="flex items-start">
              <CheckCircle className="w-5 h-5 text-indigo-400 mr-3 mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Customize each application:</strong> Our tool makes
                it easy to tailor your resume for different positions
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white/5 rounded-xl p-6 border border-white/10">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Built with privacy as the foundation. No databases, no user accounts, no tracking –
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            ...
            <p className="text-gray-400">
              Transform your academic achievements and internships into a professional resume that
              highlights your potential and enthusiasm.
            </p>
          </div>
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            <h3 className="text-xl font-semibold text-white mb-3">💼 Career Changers</h3>
            <p className="text-gray-400">
              Reframe your experience to emphasize transferable skills and demonstrate how your
              unique background adds value to your new field.
            </p>
          </div>
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
        ...
        <div className="space-y-4">
          <details className="group bg-white/5 rounded-xl p-6 border border-white/10">
            ...
            <p className="text-gray-400 mt-3">
              Yes, absolutely. We don't store any data you enter. The information is processed in
              real-time to generate your documents and then immediately discarded. No accounts, no
              databases, no tracking.
            </p>
          </details>
          <details className="group bg-white/5 rounded-xl p-6 border border-white/10">
            <summary className="cursor-pointer text-lg font-semibold text-white">
            ...
            <p className="text-gray-400 mt-3">
              Yes! After generation, you can copy the text and edit it in any word processor. The
              format is designed to be easily customizable while maintaining ATS compatibility.
            </p>
          </details>
          <details className="group bg-white/5 rounded-xl p-6 border border-white/10">
            <summary className="cursor-pointer text-lg font-semibold text-white">
            ...
            <p className="text-gray-400 mt-3">
              Claude Opus 4.1 analyzes your input (job title, experience, skills) and generates
              content that's specifically tailored to highlight relevant achievements and use
      ...
      <section className="text-center py-12 bg-gradient-to-r from-indigo-500/10 to-blue-500/10 rounded-2xl border border-white/10">
        ...
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
          Join thousands of job seekers who've successfully created professional resumes with our AI
          generator. No sign-up, no fees, just results.
        </p>
      ...
      <section className="mt-12">
        <h3 className="text-2xl font-bold text-white mb-6">
          Other Tools to Boost Your Productivity
        </h3>
        <div className="grid md:grid-cols-3 gap-4">
          <Link href="/tools/ai-summarizer" className="group">
            <div className="bg-white/5 rounded-lg p-4 border border-white/10 hover:border-indigo-400/30 transition-all">
              <h4 className="text-white font-semibold mb-2 group-hover:text-indigo-400">
                AI Text Summarizer
              </h4>
      ...
      <footer className="mt-12 pt-8 border-t border-white/10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <span className="px-3 py-1 bg-white/10 text-gray-300 rounded-md text-xs">Career</span>
          </div>
        </div>
      </footer>
    </article>
