...
import { ArrowLeft, FileText, Globe, Zap, Shield, CheckCircle, Languages, ArrowLeftRight, RefreshCw } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Extract & Translate Text from Images - Japanese ↔ English OCR with Swap Feature | AI AutoSite',
  description: 'Complete guide to using our free OCR tool with bidirectional translation and unique swap & retranslate feature. Extract text from images and translate between Japanese and English with 99% accuracy.',
  keywords: 'japanese ocr, english ocr, bidirectional translation, swap translation, reverse translation, image to text, japanese translation, english translation, tesseract, ai ocr, free ocr tool',
}
    ...
    <article className="max-w-3xl mx-auto px-4 py-8">
      ...
      <section className="prose prose-invert max-w-none space-y-6 mb-12">
        <p className="text-lg text-gray-300 leading-relaxed">
          Need to extract text from images and translate between Japanese and English? 
          Our free AI-powered OCR tool makes it simple to convert images containing any text 
          into editable, translatable content with remarkable accuracy. Plus, our unique 
          "Swap & Retranslate" feature lets you verify translation accuracy instantly.
        </p>
      </section>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Powered by Tesseract.js with specialized language models for exceptional 
                  text recognition in both Japanese and English.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 rounded-lg p-4 border border-white/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Seamlessly translate between Japanese and English. Auto-detect language 
                  or manually select translation direction.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 rounded-lg p-4 border border-white/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Unique feature to swap translation results back to input and retranslate 
                  for accuracy verification. Perfect for quality checking.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 rounded-lg p-4 border border-white/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  All OCR processing happens locally in your browser. Your images never leave 
          ...
          <div className="bg-white/5 rounded-lg p-4 border border-white/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Automatically detects whether text is in Japanese or English and 
          ...
          <div className="bg-white/5 rounded-lg p-4 border border-white/10">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Image OCR mode for extracting text from photos, or Text mode for 
                  quick copy-paste translations without images.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Select Image OCR for extracting text from images, or Text Translation 
                for quick copy-paste translations.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Choose Auto Detect for automatic language detection, or manually select 
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Upload an image (JPG, PNG, WEBP up to 10MB) or paste/type text directly 
                into the text field.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                View extracted text with confidence score and translation. Copy results 
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Click the "Swap & Retranslate" button to move the translation back to input 
                and translate in reverse direction for accuracy checking.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/5 rounded-lg p-6 border border-white/10 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Automatically identifies the language and translates to the other. 
                Perfect when you're not sure what language the text is in.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">
                After translation, swap the result back to input and translate in reverse. 
                This back-translation technique helps verify accuracy and meaning preservation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-gray-300">
          <p>
            Unlike other OCR and translation tools, we offer several unique features:
          </p>
          <ul className="space-y-3">
            <li className="flex items-start gap-2">
              ...
              <span>
                ...
                for instant back-translation testing that even major translation services don't offer.
              </span>
            </li>
            <li className="flex items-start gap-2">
            ...
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">No Character Limits:</strong> Smart chunking technology 
                handles texts of any length without quality loss.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <RefreshCw className="w-5 h-5 text-blue-400 mt-0.5" />
              <span>
                <strong className="text-white">Dual Mode Operation:</strong> Switch between image OCR 
                and direct text translation seamlessly.
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="mt-12 text-center p-8 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-2xl border border-white/10">
        <h2 className="text-2xl font-bold text-white mb-3">
          Ready to Extract and Translate Text?
        </h2>
