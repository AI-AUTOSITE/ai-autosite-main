...
export const metadata: Metadata = {
  title:
    'Introducing AI Dev Dictionary: Your Complete Guide to AI and Development Terms | AI AutoSite',
  description:
    'Master AI and development terminology with our interactive dictionary featuring visual demonstrations, code examples, and real-world applications. Perfect for developers at any level.',
  keywords:
    'AI dictionary, development terms, programming glossary, machine learning terminology, AI concepts, developer resources, interactive learning, code examples',
  openGraph: {
    title: 'AI Dev Dictionary: Interactive Learning Tool for Developers',
    description:
      'Comprehensive glossary of AI and development terms with interactive examples and visual demonstrations',
    type: 'article',
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-300 leading-relaxed">
          We're excited to launch AI Dev Dictionary, a comprehensive and interactive glossary
          designed to help developers understand the ever-evolving landscape of AI and development
          terminology.
        </p>
      </header>
      ...
      <section className="mb-12">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-gray-300 mb-4">
            The world of AI and development moves fast. New terms, concepts, and technologies emerge
            daily, making it challenging for developers to keep up. Whether you're a seasoned
            professional or just starting your journey, having a reliable reference is crucial.
          </p>
          <p className="text-gray-300 mb-4">
            Traditional glossaries are often static and boring. We wanted to create something
            different – an interactive, visual learning experience that makes understanding complex
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white/5 rounded-xl p-6 border border-white/10 hover:border-amber-500/30 transition-all"
              >
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Use the search bar to find specific terms or browse by category to explore related
                concepts.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Each term includes clear definitions, practical examples, and often interactive
                demonstrations.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Use the code examples and best practices to implement what you've learned in your
                projects.
              </p>
            </div>
          </div>
      ...
      <section className="mb-12">
        ...
        <div className="bg-white/5 rounded-xl p-6 border border-white/10">
          <p className="text-gray-300 mb-4">
            The AI Dev Dictionary is built using cutting-edge web technologies to ensure a smooth,
          ...
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-start">
              ...
              <span>
                <strong className="text-white">React & Next.js:</strong> For blazing-fast
            ...
            <li className="flex items-start">
              <Code className="w-5 h-5 text-cyan-400 mr-3 mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">TypeScript:</strong> Ensuring type safety and better
            ...
            <li className="flex items-start">
              <Code className="w-5 h-5 text-cyan-400 mr-3 mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Tailwind CSS:</strong> For beautiful, responsive
                design
              </span>
            </li>
            <li className="flex items-start">
              <Code className="w-5 h-5 text-cyan-400 mr-3 mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Interactive Components:</strong> Custom-built
        ...
        <div className="grid md:grid-cols-3 gap-6 text-center">
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            ...
            <p className="text-gray-400 text-sm">
              Keep up with the latest terminology in AI and development
            </p>
          </div>
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            ...
            <p className="text-gray-400 text-sm">
              Definitions refined by developer feedback and usage
            </p>
          </div>
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
      ...
      <section className="text-center py-12 bg-gradient-to-r from-amber-500/10 to-orange-500/10 rounded-2xl border border-white/10">
        ...
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
          Whether you're debugging AI models or building your first web app, our dictionary has the
      ...
      <footer className="mt-12 pt-8 border-t border-white/10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <span className="px-3 py-1 bg-white/10 text-gray-300 rounded-md text-xs">Learning</span>
          </div>
        </div>
      </footer>
    </article>
