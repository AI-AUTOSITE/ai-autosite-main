...
import { FileSpreadsheet, Sparkles, Table, FileText, ArrowLeft, ExternalLink, CheckCircle, Zap, Brain, Download, Clock, TrendingUp } from 'lucide-react';

export const metadata: Metadata = {
  title: 'PDF to CSV/Excel Converter - AI-Powered Table Extraction | AI-AutoSite',
  description: 'Convert PDF tables to CSV or Excel with AI. Extract data from scanned documents, invoices, and reports with 99% accuracy. Free online tool.',
  keywords: 'pdf to csv, pdf to excel, table extraction, ai data extraction, pdf converter, csv converter, excel converter, ocr, data processing',
  ...
  openGraph: {
    ...
    description: 'Extract tables from PDFs with AI. Convert to CSV or Excel format instantly. 99% accuracy.',
    type: 'article',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900">
      ...
      <header className="relative z-10 bg-white/5 backdrop-blur-md border-b border-white/10 sticky top-0">
        <nav className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link href="/blog" className="text-white hover:text-emerald-400 transition-colors flex items-center gap-2">
      ...
      <article className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Transform PDF tables into CSV or Excel files with 99% accuracy. 
            Our AI understands complex layouts, merged cells, and even scanned documents.
          </p>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-300 mb-6">
              PDF to Data is an AI-powered tool that extracts tables and structured data from PDF documents 
              and converts them into CSV or Excel format. Unlike traditional converters, our AI understands 
              context, handles complex layouts, and even works with scanned documents.
            </p>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Extract text from scanned PDFs and images</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400 mt-0.5" />
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Maintains dates, numbers, and formulas</p>
                    </div>
                  </li>
                </ul>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Convert multiple tables simultaneously</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400 mt-0.5" />
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      PDFs with visible table borders extract more accurately than borderless tables.
                    </p>
                  </div>
                </div>
        ...
        <div className="bg-gradient-to-r from-emerald-500/20 to-teal-500/20 backdrop-blur-xl border border-emerald-500/20 rounded-xl p-8 mb-12">
          <h2 className="text-2xl font-bold text-white mb-6 text-center">Simple, Transparent Pricing</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 backdrop-blur-xl border border-emerald-400/30 rounded-lg p-6">
              <div className="text-xs bg-emerald-500 text-white px-2 py-1 rounded inline-block mb-2">POPULAR</div>
              <h3 className="font-semibold text-emerald-400 mb-2">Pro Plan</h3>
              <div className="text-3xl font-bold text-white mb-4">$19<span className="text-sm text-gray-400">/month</span></div>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400 mt-0.5" />
        ...
        <div className="bg-gradient-to-r from-emerald-500/20 to-teal-500/20 backdrop-blur-xl border border-emerald-500/20 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
            Join thousands of businesses and researchers who save hours of manual data entry 
            with our AI-powered extraction tool.
          </p>
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/tools/json-csv" className="block p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-lg hover:bg-white/10 transition-all">
              <div className="flex items-center gap-3 mb-3">
                <FileText className="w-5 h-5 text-emerald-400" />
                <h4 className="font-semibold text-white">JSON to CSV</h4>
              </div>
              <p className="text-sm text-gray-400">Convert JSON data to CSV format for spreadsheets.</p>
            </Link>
            <Link href="/tools/pdf-summarizer" className="block p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-lg hover:bg-white/10 transition-all">
              <div className="flex items-center gap-3 mb-3">
                <Sparkles className="w-5 h-5 text-teal-400" />
                <h4 className="font-semibold text-white">PDF Summarizer</h4>
              </div>
              <p className="text-sm text-gray-400">Get AI-powered summaries of long PDF documents.</p>
            </Link>
            <Link href="/tools/token-compressor" className="block p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-lg hover:bg-white/10 transition-all">
              <div className="flex items-center gap-3 mb-3">
                <Brain className="w-5 h-5 text-green-400" />
                <h4 className="font-semibold text-white">Token Compressor</h4>
              </div>
              <p className="text-sm text-gray-400">Compress documents for efficient AI processing.</p>
            </Link>
          </div>
        </div>
