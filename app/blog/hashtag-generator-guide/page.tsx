...
export const metadata: Metadata = {
  ...
  description:
    'Generate perfect hashtags for social media. Learn hashtag strategies to increase reach and engagement on Instagram, Twitter, and TikTok.',
  keywords:
    'hashtag generator, instagram hashtags, twitter tags, tiktok hashtags, social media marketing, hashtag strategy',
  openGraph: {
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-300 leading-relaxed">
          Learn how to generate perfect hashtags for Instagram, Twitter, and TikTok. Boost
          engagement with strategic tag selection and proven hashtag techniques.
        </p>
      </header>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-gray-400 text-sm">Posts with hashtags get 12.6% more engagement</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
            ...
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-gray-400 text-sm">Appear in searches and explore pages</p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-white/5 rounded-xl p-6 border border-pink-500/20 mb-4">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-300">
                <strong className="text-white">Best Mix:</strong> 30% popular + 50% medium + 20%
                niche tags
              </p>
          ...
          <div className="bg-white/5 rounded-xl p-6 border border-blue-500/20 mb-4">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-300">
                <strong className="text-white">Strategy:</strong> Focus on trending and relevant
                tags
              </p>
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-start gap-2">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Describe what's in your post (#sunset, #coffee, #workout)
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Your niche or field (#digitalmarketing, #foodie, #fitness)
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Connect with groups (#igers, #bookstagram, #techtwitter)
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Your unique tags (#yourbrand, #yourcampaign)
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <p className="text-gray-300">
                  <strong className="text-white">Using banned hashtags:</strong> Check if tags are
                  shadowbanned
                </p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-400">❌</span>
                <p className="text-gray-300">
                  <strong className="text-white">Only popular tags:</strong> You'll get lost in
                  millions of posts
                </p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-400">❌</span>
                <p className="text-gray-300">
                  <strong className="text-white">Irrelevant tags:</strong> Hurts your engagement
                  rate
                </p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-400">❌</span>
                <p className="text-gray-300">
                  <strong className="text-white">Same tags every post:</strong> Algorithm sees this
                  as spam
                </p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-400">❌</span>
                <p className="text-gray-300">
                  <strong className="text-white">Too generic:</strong> #love #happy won't help you
                  stand out
                </p>
              </li>
            </ul>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-xl p-4 border border-cyan-500/20">
              <p className="text-gray-300">
                <span className="text-cyan-400 font-semibold">Research competitors:</span> See what
                hashtags successful accounts in your niche use
              </p>
            </div>
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-xl p-4 border border-purple-500/20">
              <p className="text-gray-300">
                <span className="text-purple-400 font-semibold">Create hashtag sets:</span> Save
                different sets for different types of content
              </p>
            </div>
            <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 rounded-xl p-4 border border-yellow-500/20">
              <p className="text-gray-300">
                <span className="text-yellow-400 font-semibold">Track performance:</span> Monitor
                which hashtags bring the most engagement
              </p>
            </div>
            <div className="bg-gradient-to-br from-green-500/10 to-teal-500/10 rounded-xl p-4 border border-green-500/20">
              <p className="text-gray-300">
                <span className="text-green-400 font-semibold">Update regularly:</span> Hashtag
                trends change, refresh your strategy monthly
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="text-center py-12 bg-gradient-to-r from-pink-500/10 to-purple-500/10 rounded-2xl border border-white/10 mt-12">
        <h2 className="text-3xl font-bold text-white mb-4">Generate Perfect Hashtags Now</h2>
