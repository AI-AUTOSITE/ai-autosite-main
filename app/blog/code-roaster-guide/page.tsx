...
export const metadata: Metadata = {
  ...
  description:
    'Discover Code Roaster, the revolutionary AI-powered code review tool that combines humor with helpful feedback. Learn how it can level up your coding skills while keeping you entertained.',
  keywords:
    'code roaster, ai code review, programming feedback, code analysis, developer tools, code improvement, debugging help, programming humor',
  openGraph: {
  ...
  const features = [
    {
      ...
      title: 'Roast Mode',
      description:
        'Get brutally honest feedback with a side of humor. Learn from your mistakes while laughing at them.',
    ...
    },
    {
      ...
      title: 'Explain Mode',
      description:
        'Receive clear, beginner-friendly explanations of your code and its potential issues.',
  ...
  const useCases = [
    {
      ...
      description:
        'Perfect for beginners who want honest feedback without the intimidation factor.',
    },
    {
      title: 'Code Reviews',
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-300 leading-relaxed">
          Tired of boring code reviews? Meet Code Roaster – the AI-powered tool that turns code
          feedback into an entertaining learning experience. Get roasted, learn, and improve your
          coding skills, all while having a good laugh at your bugs.
        </p>
      </header>
      ...
      <section className="mb-12">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
          <p className="text-gray-300 mb-4">
            ...
            non-existent when you're learning alone. Code Roaster changes the game by making code
            feedback both educational and entertaining.
          </p>
          <p className="text-gray-300 mb-4">
            Whether you're a beginner afraid to ask "stupid questions" or an experienced developer
            looking for a quick sanity check, Code Roaster provides instant, judgment-free (well,
            humorously judgmental) feedback that sticks with you.
          </p>
          <p className="text-gray-300">
            The best part? You'll actually remember the lessons because they made you laugh. Studies
            show that humor enhances memory retention – so getting roasted might just be the best
            way to level up your coding skills.
          </p>
        </div>
      </section>
          ...
          <ol className="space-y-4">
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Drop any code snippet into the input area – up to 10,000 characters.
                </p>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Select Roast for humor, Explain for education, or Fix for solutions.
                </p>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Receive AI-powered analysis in seconds, tailored to your chosen mode.
                </p>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Apply the feedback to your code and watch your skills grow.
                </p>
              </div>
            </li>
          </ol>
        ...
        <div className="bg-green-500/10 backdrop-blur-sm rounded-2xl p-6 border border-green-500/20">
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-start gap-3">
              ...
              <span>
                No code storage – everything is processed temporarily and deleted immediately
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-green-400 mt-1">✓</span>
      ...
      <section className="text-center py-12 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-2xl border border-white/10">
        ...
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
          Join thousands of developers who are learning faster and having more fun with Code
          Roaster. It's free, instant, and guaranteed to make you a better coder (or at least make
          you laugh trying).
        </p>
        <Link
