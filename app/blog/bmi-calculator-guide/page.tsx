...
export const metadata: Metadata = {
  ...
  description:
    'Calculate your BMI (Body Mass Index) instantly. Understand your weight category and health risks. Free BMI calculator with health tips.',
  keywords:
    'bmi calculator, body mass index, weight calculator, health calculator, obesity calculator, ideal weight',
  openGraph: {
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-300 leading-relaxed">
          Calculate your Body Mass Index and understand what it means for your health. Get
      ...
      <section className="space-y-12">
        ...
        <div>
          ...
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            <p className="text-gray-300 mb-4">
              BMI (Body Mass Index) is a measure of body fat based on height and weight. It's
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-gray-400 text-sm">Screen for cardiovascular risks</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <Activity className="w-8 h-8 text-green-400 mb-2" />
              <h3 className="text-white font-semibold mb-2">Fitness Goals</h3>
              <p className="text-gray-400 text-sm">Track weight management progress</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <TrendingUp className="w-8 h-8 text-blue-400 mb-2" />
              <h3 className="text-white font-semibold mb-2">Health Screening</h3>
              <p className="text-gray-400 text-sm">Identify potential health issues</p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            <p className="text-gray-300 mb-4">While BMI is useful, it doesn't account for:</p>
            <ul className="space-y-2 text-gray-300">
              <li>
                • <strong className="text-white">Muscle mass:</strong> Athletes may have high BMI
                but low body fat
              </li>
              <li>
                • <strong className="text-white">Bone density:</strong> Varies between individuals
              </li>
              <li>
                • <strong className="text-white">Body composition:</strong> Fat vs muscle
                distribution
              </li>
              <li>
                • <strong className="text-white">Age and gender:</strong> Different standards apply
              </li>
              <li>
                • <strong className="text-white">Ethnicity:</strong> Risk levels vary by background
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <p className="text-gray-300">Exercise regularly - at least 150 minutes per week</p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">🥗</span>
                <p className="text-gray-300">Eat a balanced diet with fruits and vegetables</p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">💧</span>
                <p className="text-gray-300">Stay hydrated - drink 8 glasses of water daily</p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">😴</span>
                <p className="text-gray-300">Get enough sleep - 7-9 hours per night</p>
              </li>
              <li className="flex items-start gap-2">
      ...
      <section className="text-center py-12 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-2xl border border-white/10 mt-12">
        <h2 className="text-3xl font-bold text-white mb-4">Calculate Your BMI Now</h2>
