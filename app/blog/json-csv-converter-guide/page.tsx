...
export const metadata: Metadata = {
  ...
  description: 'Learn how to convert JSON to CSV and CSV to JSON. Free online converter for developers and data analysts. Handle API data easily.',
  keywords: 'json to csv, csv to json, data converter, json converter, csv converter, api data conversion',
  openGraph: {
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-300 leading-relaxed">
          Convert between JSON and CSV formats easily. Perfect for API data, 
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-2">
              ...
              <p className="text-gray-300">
                <strong className="text-white">API Integration:</strong> Convert REST API JSON responses to CSV for analysis
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-400 mt-1">•</span>
              <p className="text-gray-300">
                <strong className="text-white">Data Migration:</strong> Move data between different systems
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-purple-400 mt-1">•</span>
              <p className="text-gray-300">
                <strong className="text-white">Report Generation:</strong> Create Excel-compatible reports from JSON
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-orange-400 mt-1">•</span>
              <p className="text-gray-300">
                <strong className="text-white">Backup:</strong> Export database data in portable formats
              </p>
            </li>
          </ul>
        </div>
