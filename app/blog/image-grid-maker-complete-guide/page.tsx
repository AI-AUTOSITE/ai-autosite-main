...
export const metadata: Metadata = {
  ...
  description: 'Learn how to create numbered photo grids for comparisons, tutorials, and portfolios. Perfect for before/after shots, step-by-step guides, and visual storytelling.',
  keywords: 'image grid, photo collage, grid maker, before after, tutorial images, photo grid creator, numbered grids',
  openGraph: {
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12">
        ...
        <p className="text-xl text-gray-300 leading-relaxed">
          Transform multiple images into organized, numbered grids. Perfect for before/after comparisons, 
          step-by-step tutorials, and professional portfolios—all in your browser.
        </p>
      </header>
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-gray-300 leading-relaxed mb-4">
              In today's visual world, presenting multiple images clearly is crucial. Whether you're showing 
              transformation results, creating tutorials, or building portfolios, image grids help tell your 
              story effectively.
            </p>
            <p className="text-gray-300 leading-relaxed">
              Our Image Grid Maker eliminates the complexity of photo editing software. No downloads, 
              no subscriptions—just drag, drop, and download your perfect grid.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-xl p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300">
                Everything happens in your browser. No uploads, no waiting—see your grid 
                update in real-time as you add images.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-xl p-6 border border-purple-500/20">
              ...
              <p className="text-gray-300">
                Create grids from 1×1 to 8×8 (up to 64 images). Perfect for any comparison 
                or collection size you need.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-xl p-6 border border-green-500/20">
              ...
              <p className="text-gray-300">
                Optional number overlays help viewers follow sequences. Perfect for tutorials 
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">Drag and drop multiple images at once or click to select</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">Toggle numbers on/off, replace any image by clicking its cell</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">Click "Merge & Download" to save your grid as a single image</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white/5 rounded-xl p-6">
              ...
              <p className="text-gray-300">
                Create engaging carousel alternatives, Instagram grids, or Pinterest-ready 
                collages that stand out.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl p-8 border border-purple-500/20">
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-2">
              ...
              <p className="text-gray-300">
                <strong className="text-white">Use consistent image sizes:</strong> For the cleanest look, 
            ...
            <li className="flex items-start gap-2">
              <span className="text-purple-400 mt-1">•</span>
              <p className="text-gray-300">
                <strong className="text-white">Batch processing:</strong> Select and drop all images at 
                once to fill your grid instantly
              </p>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-purple-400 mt-1">•</span>
      ...
      <section className="text-center py-12 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-2xl border border-white/10 mt-12">
        <h2 className="text-3xl font-bold text-white mb-4">
          Start Creating Your Image Grid Now
        </h2>
