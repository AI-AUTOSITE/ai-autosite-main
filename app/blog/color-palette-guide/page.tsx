...
export const metadata: Metadata = {
  ...
  description:
    'Learn how to create beautiful color palettes for web design, branding, and art. Free color scheme generator included.',
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12">
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-4">
          <span className="px-3 py-1 bg-pink-500/20 text-pink-400 rounded-full">Design</span>
          <span>•</span>
        ...
        <p className="text-xl text-gray-300 leading-relaxed">
          Master the art of color combinations. Learn how to create stunning palettes for websites,
          apps, and designs.
        </p>
      </header>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              ...
              <p className="text-gray-400 text-sm">90% of snap judgments are based on color</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <Brush className="w-8 h-8 text-purple-400 mb-2" />
              <h3 className="text-white font-semibold mb-2">Brand Identity</h3>
              <p className="text-gray-400 text-sm">Colors increase brand recognition by 80%</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 border border-white/10">
              <Monitor className="w-8 h-8 text-green-400 mb-2" />
              <h3 className="text-white font-semibold mb-2">User Experience</h3>
              <p className="text-gray-400 text-sm">Good colors improve readability and usability</p>
            </div>
          </div>
        </div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-2">
              ...
              <p className="text-gray-300">
                <strong className="text-white">Website Design:</strong> Headers, buttons,
                backgrounds
              </p>
            </li>
            <li className="flex items-start gap-2">
          ...
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <p className="text-gray-300">Use 3-5 colors maximum for clean design</p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">💡</span>
                <p className="text-gray-300">
              ...
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">💡</span>
                <p className="text-gray-300">Test colors for accessibility (contrast ratio)</p>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-cyan-400">💡</span>
                <p className="text-gray-300">Consider color psychology and cultural meanings</p>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="text-center py-12 bg-gradient-to-r from-pink-500/10 via-purple-500/10 to-blue-500/10 rounded-2xl border border-white/10 mt-12">
        <h2 className="text-3xl font-bold text-white mb-4">Generate Your Perfect Palette</h2>
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
          Free color palette generator with instant preview. Create beautiful color schemes in
          seconds.
        </p>
        <Link
